...
var List = function () {
    function List(json) {
        ...
        json.forEach(function (item) {
            return _this.list_items.push(new _ListItem2.default(item));
        });
    }
    ...
    _createClass(List, [{
        key: 'html',
        value: function html() {
            return '<ul>' + this.list_items.map(function (li) {
                return li.html();
            }).join('\n') + '</ul>';
        }
    }]);
...
var url = 'https://dof4jdwm56.execute-api.us-west-2.amazonaws.com/prod/cruftyGov';
...
fetch(url).then(function (response) {
    ...
    var ul = new _List2.default(json);
